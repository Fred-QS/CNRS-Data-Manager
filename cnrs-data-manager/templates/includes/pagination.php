...
<div class="cnrs-dm-front-pagination-wrapper">
    <div class="cnrs-dm-front-pagination<?= $pages < 2 ? ' one-page' : '' ?>">
        <span class="cnrs-dm-front-pagination-displaying-num"><?= $rowsCount . ' ' .  __('elements') ?></span>
        <span class="cnrs-dm-front-pagination-pagination-links">
            <?php if($previous !== null): ?>
                <a class="cnrs-dm-front-pagination-first-page button" href="<?= sanitizeURIForPagination(1, 'front') ?>">
                ...
                <a class="cnrs-dm-front-pagination-prev-page button" href="<?= sanitizeURIForPagination($previous, 'front') ?>">
            ...
            <?php if($next !== null): ?>
                <a class="cnrs-dm-front-pagination-next-page button" href="<?= sanitizeURIForPagination($next, 'front') ?>">
                ...
                <a class="cnrs-dm-front-pagination-last-page button" href="<?= sanitizeURIForPagination($pages, 'front') ?>">
