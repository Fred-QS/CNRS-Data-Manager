<div class="cnrs-dm-form-tool-render" data-type="textarea" data-index="<?php echo $iteration ?>">
    ...
    <p class="cnrs-dm-form-tool-label"><?php echo __('Text field', 'cnrs-data-manager') ?></p>
