<div class="cnrs-dm-form-tool-render" data-type="number" data-index="<?php echo $iteration ?>">
    ...
    <p class="cnrs-dm-form-tool-label"><?php echo __('Numeric field', 'cnrs-data-manager') ?></p>
