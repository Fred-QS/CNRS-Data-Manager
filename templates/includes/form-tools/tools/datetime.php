<div class="cnrs-dm-form-tool-render" data-type="datetime" data-index="<?php echo $iteration ?>">
    ...
    <p class="cnrs-dm-form-tool-label"><?php echo __('Date & time field', 'cnrs-data-manager') ?></p>
