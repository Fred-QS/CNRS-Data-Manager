<div class="cnrs-dm-form-tool-render" data-type="input" data-index="<?php echo $iteration ?>">
    ...
    <p class="cnrs-dm-form-tool-label"><?php echo __('Input field', 'cnrs-data-manager') ?></p>
