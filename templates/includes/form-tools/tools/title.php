<div class="cnrs-dm-form-tool-render" data-type="title" data-index="<?php echo $iteration ?>">
    ...
    <p class="cnrs-dm-form-tool-label"><?php echo __('Title field', 'cnrs-data-manager') ?></p>
    <i><?php echo __('Add a title.', 'cnrs-data-manager') ?></i>
