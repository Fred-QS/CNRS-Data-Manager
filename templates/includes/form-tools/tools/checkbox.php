<div class="cnrs-dm-form-tool-render" data-type="checkbox" data-index="<?php echo $iteration ?>">
    ...
    <p class="cnrs-dm-form-tool-label"><?php echo __('Multi choice field', 'cnrs-data-manager') ?></p>
    <i><?php echo __('Add some choices.', 'cnrs-data-manager') ?></i>
