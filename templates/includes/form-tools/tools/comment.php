<div class="cnrs-dm-form-tool-render" data-type="comment" data-index="<?php echo $iteration ?>">
    ...
    <p class="cnrs-dm-form-tool-label"><?php echo __('Comment field', 'cnrs-data-manager') ?></p>
    <i><?php echo __('Edit your comment...', 'cnrs-data-manager') ?></i>
