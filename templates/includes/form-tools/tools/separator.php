<div class="cnrs-dm-form-tool-render" data-type="separator" data-index="<?php echo $iteration ?>">
    ...
    <p class="cnrs-dm-form-tool-label"><?php echo __('Separator', 'cnrs-data-manager') ?></p>
    <div class="cnrs-dm-tool-buttons-wrapper">
        ...
        <span class="cnrs-dm-tool-button cnrs-dm-tool-button-solo" data-action="delete">
