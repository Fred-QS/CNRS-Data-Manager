        ...
        <div class="cnrs-dm-front-pagination<?php echo $pages < 2 ? ' one-page' : '' ?>">
            ...
            <span class="cnrs-dm-front-pagination-pagination-links">
                <?php if($previous !== null): ?>
                    <a class="cnrs-dm-front-pagination-first-page button" href="<?php echo sanitizeURIForPagination(1, $mode) ?>">
                    ...
                    <a class="cnrs-dm-front-pagination-prev-page button" href="<?php echo sanitizeURIForPagination($previous, $mode) ?>">
                ...
                <span class="cnrs-dm-front-pagination-paging">
                    <span class="cnrs-dm-front-pagination-paging-text"><?php echo $current ?>
                        <?php echo __('of', 'cnrs-data-manager') ?>
                        <span class="cnrs-dm-front-pagination-total-pages"><?php echo $pages ?></span>
                    </span>
                </span>
                <?php if($next !== null): ?>
                    <a class="cnrs-dm-front-pagination-next-page button" href="<?php echo sanitizeURIForPagination($next, $mode) ?>">
                    ...
                    <a class="cnrs-dm-front-pagination-last-page button" href="<?php echo sanitizeURIForPagination($pages, $mode) ?>">
