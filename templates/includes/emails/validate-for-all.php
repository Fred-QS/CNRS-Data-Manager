<div id="cnrs-dm-email-body-wrapper-revision">
    ...
    <p id="cnrs-dm-email-p1"><?php echo __('A mission has been validated !', 'cnrs-data-manager') ?></p>
    <p id="cnrs-dm-email-p2"><?php echo __('You can find the form by clicking on the link below.', 'cnrs-data-manager') ?></p>
