...
namespace CnrsDataManager\Excel\Style;
...
class Alignment extends Supervisor
{
     ...
     *        [
     *            'horizontal'   => \CnrsDataManager\Excel\Style\Alignment::HORIZONTAL_CENTER,
     *            'vertical'     => \CnrsDataManager\Excel\Style\Alignment::VERTICAL_CENTER,
     *            'textRotation' => 0,
     *            'wrapText'     => TRUE
     *        ]
     * );
