...
namespace CnrsDataManager\Excel\Shared\OLE\PPS;
...
use CnrsDataManager\Excel\Shared\OLE\PPS;
...
class Root extends PPS
{
    ...
    /**
     * Saving big data (PPS's with data bigger than \CnrsDataManager\Excel\Shared\OLE::OLE_DATA_SIZE_SMALL).
     *
    ...
    /**
     * get small data (PPS's with data smaller than \CnrsDataManager\Excel\Shared\OLE::OLE_DATA_SIZE_SMALL).
     *
     * @param array $raList Reference to array of PPS's
     */
