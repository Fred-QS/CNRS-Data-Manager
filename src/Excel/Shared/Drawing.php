...
namespace CnrsDataManager\Excel\Shared;
...
class Drawing
{
     ...
     */
    public static function pixelsToCellDimension(int $pixelValue, \CnrsDataManager\Excel\Style\Font $defaultFont): int|float
    {
        // Font name and size
     ...
     * @param \CnrsDataManager\Excel\Style\Font $defaultFont Default font of the workbook
     *
     * @return int Value in pixels
     */
    public static function cellDimensionToPixels(float $cellWidth, \CnrsDataManager\Excel\Style\Font $defaultFont): int
    {
        // Font name and size
        $name = $defaultFont->getName();
        $size = $defaultFont->getSize();
