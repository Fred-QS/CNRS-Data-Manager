...
use CnrsDataManager\Excel\Chart\Renderer\IRenderer;
use CnrsDataManager\Excel\Collection\Memory;
use CnrsDataManager\Libs\Psr\Http\Client\ClientInterface;
use CnrsDataManager\Libs\Psr\Http\Message\RequestFactoryInterface;
use CnrsDataManager\Libs\Psr\SimpleCache\CacheInterface;
use ReflectionClass;
...
class Settings
{
     ...
     * eg: CnrsDataManager\Excel\Chart\Renderer\JpGraph.
     *
