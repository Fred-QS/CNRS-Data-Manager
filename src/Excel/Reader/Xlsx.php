...
namespace CnrsDataManager\Excel\Reader;

use CnrsDataManager\Excel\Cell\Coordinate;
use CnrsDataManager\Excel\Cell\DataType;
use CnrsDataManager\Excel\Cell\Hyperlink;
use CnrsDataManager\Excel\DefinedName;
use CnrsDataManager\Excel\Reader\Security\XmlScanner;
use CnrsDataManager\Excel\Reader\Xlsx\AutoFilter;
use CnrsDataManager\Excel\Reader\Xlsx\Chart;
use CnrsDataManager\Excel\Reader\Xlsx\ColumnAndRowAttributes;
use CnrsDataManager\Excel\Reader\Xlsx\ConditionalStyles;
use CnrsDataManager\Excel\Reader\Xlsx\DataValidations;
use CnrsDataManager\Excel\Reader\Xlsx\Hyperlinks;
use CnrsDataManager\Excel\Reader\Xlsx\Namespaces;
use CnrsDataManager\Excel\Reader\Xlsx\PageSetup;
use CnrsDataManager\Excel\Reader\Xlsx\Properties as PropertyReader;
use CnrsDataManager\Excel\Reader\Xlsx\SharedFormula;
use CnrsDataManager\Excel\Reader\Xlsx\SheetViewOptions;
use CnrsDataManager\Excel\Reader\Xlsx\SheetViews;
use CnrsDataManager\Excel\Reader\Xlsx\Styles;
use CnrsDataManager\Excel\Reader\Xlsx\TableReader;
use CnrsDataManager\Excel\Reader\Xlsx\Theme;
use CnrsDataManager\Excel\Reader\Xlsx\WorkbookView;
use CnrsDataManager\Excel\ReferenceHelper;
use CnrsDataManager\Excel\RichText\RichText;
use CnrsDataManager\Excel\Settings;
use CnrsDataManager\Excel\Shared\Date;
use CnrsDataManager\Excel\Shared\Drawing;
use CnrsDataManager\Excel\Shared\File;
use CnrsDataManager\Excel\Shared\Font;
use CnrsDataManager\Excel\Shared\StringHelper;
use CnrsDataManager\Excel\Spreadsheet;
use CnrsDataManager\Excel\Style\Color;
use CnrsDataManager\Excel\Style\Font as StyleFont;
use CnrsDataManager\Excel\Style\NumberFormat;
use CnrsDataManager\Excel\Style\Style;
use CnrsDataManager\Excel\Worksheet\HeaderFooterDrawing;
...
class Xlsx extends BaseReader
{
                                        ...
                                        if (isset($shape['style'])) {
                                            ...
                                            if (($column !== null) && ($row !== null)) {
                                                ...
                                                if (isset($drowingImages[$fillImageRelId])) {
                                                    $objDrawing = new \CnrsDataManager\Excel\Worksheet\Drawing();
    ...
    private function readHyperLinkDrawing(\CnrsDataManager\Excel\Worksheet\Drawing $objDrawing, SimpleXMLElement $cellAnchor, array $hyperlinks): void
    {
