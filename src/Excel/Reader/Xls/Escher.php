...
class Escher
{
     ...
     */
    private BSE|BstoreContainer|DgContainer|DggContainer|\CnrsDataManager\Excel\Shared\Escher|SpContainer|SpgrContainer $object;

    /**
     * Create a new Escher instance.
     */
    public function __construct(BSE|BstoreContainer|DgContainer|DggContainer|\CnrsDataManager\Excel\Shared\Escher|SpContainer|SpgrContainer $object)
    {
        $this->object = $object;
    }
     ...
     */
    public function load(string $data): BSE|BstoreContainer|DgContainer|DggContainer|\CnrsDataManager\Excel\Shared\Escher|SpContainer|SpgrContainer
    {
        $this->data = $data;
