...
use CnrsDataManager\Excel\Reader\Gnumeric;
use CnrsDataManager\Excel\Spreadsheet;
use CnrsDataManager\Excel\Worksheet\PageMargins;
use CnrsDataManager\Excel\Worksheet\PageSetup as WorksheetPageSetup;
