...
namespace CnrsDataManager\Excel\Reader\Xlsx;

use CnrsDataManager\Excel\Calculation\Information\ExcelError;
use CnrsDataManager\Excel\Chart\Axis;
use CnrsDataManager\Excel\Chart\AxisText;
use CnrsDataManager\Excel\Chart\ChartColor;
use CnrsDataManager\Excel\Chart\DataSeries;
use CnrsDataManager\Excel\Chart\DataSeriesValues;
use CnrsDataManager\Excel\Chart\GridLines;
use CnrsDataManager\Excel\Chart\Layout;
use CnrsDataManager\Excel\Chart\Legend;
use CnrsDataManager\Excel\Chart\PlotArea;
use CnrsDataManager\Excel\Chart\Properties as ChartProperties;
use CnrsDataManager\Excel\Chart\Title;
use CnrsDataManager\Excel\Chart\TrendLine;
use CnrsDataManager\Excel\Reader\Xlsx;
...
class Chart
{
    ...
    public function readChart(SimpleXMLElement $chartElements, string $chartName): \CnrsDataManager\Excel\Chart\Chart
    {
        ...
        $chart = new \CnrsDataManager\Excel\Chart\Chart($chartName, $title, $legend, $plotArea, $plotVisOnly, (string) $dispBlanksAs, $XaxisLabel, $YaxisLabel, $xAxis, $yAxis);
        if ($chartNoFill) {
