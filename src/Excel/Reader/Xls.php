...
use CnrsDataManager\Excel\Cell\DataValidation;
use CnrsDataManager\Excel\Exception as PhpSpreadsheetException;
use CnrsDataManager\Excel\NamedRange;
use CnrsDataManager\Excel\Reader\Xls\ConditionalFormatting;
use CnrsDataManager\Excel\Reader\Xls\Style\CellFont;
use CnrsDataManager\Excel\Reader\Xls\Style\FillPattern;
use CnrsDataManager\Excel\RichText\RichText;
use CnrsDataManager\Excel\Shared\CodePage;
use CnrsDataManager\Excel\Shared\Date;
use CnrsDataManager\Excel\Shared\Escher;
use CnrsDataManager\Excel\Shared\Escher\DgContainer\SpgrContainer\SpContainer;
use CnrsDataManager\Excel\Shared\Escher\DggContainer\BstoreContainer\BSE;
use CnrsDataManager\Excel\Shared\File;
use CnrsDataManager\Excel\Shared\OLE;
use CnrsDataManager\Excel\Shared\OLERead;
use CnrsDataManager\Excel\Shared\StringHelper;
use CnrsDataManager\Excel\Shared\Xls as SharedXls;
use CnrsDataManager\Excel\Spreadsheet;
use CnrsDataManager\Excel\Style\Alignment;
