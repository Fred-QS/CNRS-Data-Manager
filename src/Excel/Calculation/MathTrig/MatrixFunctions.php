...
use CnrsDataManager\Libs\Matrix\Builder;
use CnrsDataManager\Libs\Matrix\Div0Exception as MatrixDiv0Exception;
use CnrsDataManager\Libs\Matrix\Exception as MatrixException;
