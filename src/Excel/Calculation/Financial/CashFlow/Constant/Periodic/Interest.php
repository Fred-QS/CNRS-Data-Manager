...
namespace CnrsDataManager\Excel\Calculation\Financial\CashFlow\Constant\Periodic;

use CnrsDataManager\Excel\Calculation\Exception;
use CnrsDataManager\Excel\Calculation\Financial\CashFlow\CashFlowValidations;
