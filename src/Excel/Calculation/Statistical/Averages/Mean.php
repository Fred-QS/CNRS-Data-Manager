...
namespace CnrsDataManager\Excel\Calculation\Statistical\Averages;

use CnrsDataManager\Excel\Calculation\Functions;
use CnrsDataManager\Excel\Calculation\Information\ExcelError;
use CnrsDataManager\Excel\Calculation\MathTrig;
use CnrsDataManager\Excel\Calculation\Statistical\Averages;
use CnrsDataManager\Excel\Calculation\Statistical\Counts;
use CnrsDataManager\Excel\Calculation\Statistical\Minimum;
