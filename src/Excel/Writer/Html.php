...
use CnrsDataManager\Excel\Chart\Chart;
use CnrsDataManager\Excel\Document\Properties;
...
use CnrsDataManager\Excel\Shared\Drawing as SharedDrawing;
use CnrsDataManager\Excel\Shared\File;
use CnrsDataManager\Excel\Shared\Font as SharedFont;
...
use CnrsDataManager\Libs\Voku\helper\AntiXSS;
...
class Html extends BaseWriter
{
    ...
    private function generateRowWriteCell(
        ...
        if (!$this->useInlineCss && !$this->isPdf && is_string($cssClass)) {
            ...
            //** Necessary redundant code for the sake of \CnrsDataManager\Excel\Writer\Pdf **
