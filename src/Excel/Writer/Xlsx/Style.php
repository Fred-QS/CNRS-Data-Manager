...
class Style extends WriterPart
{
     ...
     * Write Cell Style Xf.
     */
    private function writeCellStyleXf(XMLWriter $objWriter, \CnrsDataManager\Excel\Style\Style $style, Spreadsheet $spreadsheet, string $defaultAlignHash): void
    {
        // xf
        $objWriter->startElement('xf');
        $objWriter->writeAttribute('xfId', '0');
     ...
     */
    private function writeCellStyleDxf(XMLWriter $objWriter, \CnrsDataManager\Excel\Style\Style $style): void
    {
        // dxf
     ...
     *
     * @return \CnrsDataManager\Excel\Style\Style[] All styles in PhpSpreadsheet
     */
