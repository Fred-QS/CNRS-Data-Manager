...
class Comments extends WriterPart
{
     ...
     */
    public function writeComments(\CnrsDataManager\Excel\Worksheet\Worksheet $worksheet): string
    {
        // Create XML writer
        $objWriter = null;
     ...
     * @return string XML Output
     */
    public function writeVMLComments(\CnrsDataManager\Excel\Worksheet\Worksheet $worksheet): string
    {
        // Create XML writer
        $objWriter = null;
        if ($this->getParentWriter()->getUseDiskCaching()) {
