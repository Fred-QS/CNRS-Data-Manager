...
use CnrsDataManager\Excel\Style\ConditionalFormatting\ConditionalColorScale;
use CnrsDataManager\Excel\Style\ConditionalFormatting\ConditionalDataBar;
use CnrsDataManager\Excel\Style\ConditionalFormatting\ConditionalFormattingRuleExtension;
use CnrsDataManager\Excel\Worksheet\RowDimension;
use CnrsDataManager\Excel\Worksheet\SheetView;
use CnrsDataManager\Excel\Worksheet\Worksheet as PhpspreadsheetWorksheet;
...
class Worksheet extends WriterPart
{
    ...
    private function writeDrawings(XMLWriter $objWriter, PhpspreadsheetWorksheet $worksheet, bool $includeCharts = false): void
    {
        ...
        if (isset($unparsedLoadedData['sheets'][$worksheet->getCodeName()]['drawingOriginalIds'])) {
            ...
            // (! synchronize with \CnrsDataManager\Excel\Writer\Xlsx\Rels::writeWorksheetRelationships)
