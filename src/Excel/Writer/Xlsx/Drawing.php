...
class Drawing extends WriterPart
{
     ...
     */
    public function writeDrawings(\CnrsDataManager\Excel\Worksheet\Worksheet $worksheet, bool $includeCharts = false): string
    {
        // Create XML writer
        $objWriter = null;
     ...
     * Write drawings to XML format.
     */
    public function writeChart(XMLWriter $objWriter, \CnrsDataManager\Excel\Chart\Chart $chart, int $relationId = -1): void
    {
     ...
     * @return string XML Output
     */
    public function writeVMLHeaderFooterImages(\CnrsDataManager\Excel\Worksheet\Worksheet $worksheet): string
    {
        // Create XML writer
        $objWriter = null;
        if ($this->getParentWriter()->getUseDiskCaching()) {
