...
use CnrsDataManager\Excel\Shared\Escher\DgContainer;
...
use CnrsDataManager\Excel\Shared\Escher\DggContainer;
use CnrsDataManager\Excel\Shared\Escher\DggContainer\BstoreContainer;
use CnrsDataManager\Excel\Shared\Escher\DggContainer\BstoreContainer\BSE;
use CnrsDataManager\Excel\Shared\Escher\DggContainer\BstoreContainer\BSE\Blip;
use CnrsDataManager\Excel\Shared\OLE;
use CnrsDataManager\Excel\Shared\OLE\PPS\File;
use CnrsDataManager\Excel\Shared\OLE\PPS\Root;
use CnrsDataManager\Excel\Spreadsheet;
use CnrsDataManager\Excel\Worksheet\BaseDrawing;
use CnrsDataManager\Excel\Worksheet\Drawing;
use CnrsDataManager\Excel\Worksheet\MemoryDrawing;
use CnrsDataManager\Excel\Writer\Xls\Parser;
use CnrsDataManager\Excel\Writer\Xls\Workbook;
use CnrsDataManager\Excel\Writer\Xls\Worksheet;
    ...
    private function buildWorksheetEschers(): void
    {
        ...
        foreach ($this->spreadsheet->getAllsheets() as $sheet) {
            ...
            foreach ($sheet->getDrawingCollection() as $drawing) {
                ...
                $twoAnchor = \CnrsDataManager\Excel\Shared\Xls::oneAnchor2twoAnchor($sheet, $coordinates, $offsetX, $offsetY, $width, $height);
