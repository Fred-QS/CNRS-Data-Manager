...
use CnrsDataManager\Excel\HashTable;
use CnrsDataManager\Excel\Spreadsheet;
use CnrsDataManager\Excel\Style\Borders;
use CnrsDataManager\Excel\Style\Conditional;
use CnrsDataManager\Excel\Style\Fill;
use CnrsDataManager\Excel\Style\Font;
use CnrsDataManager\Excel\Style\NumberFormat;
use CnrsDataManager\Excel\Worksheet\BaseDrawing;
use CnrsDataManager\Excel\Worksheet\Drawing as WorksheetDrawing;
use CnrsDataManager\Excel\Worksheet\MemoryDrawing;
use CnrsDataManager\Excel\Writer\Exception as WriterException;
use CnrsDataManager\Excel\Writer\Xlsx\Chart;
use CnrsDataManager\Excel\Writer\Xlsx\Comments;
use CnrsDataManager\Excel\Writer\Xlsx\ContentTypes;
use CnrsDataManager\Excel\Writer\Xlsx\DocProps;
use CnrsDataManager\Excel\Writer\Xlsx\Drawing;
use CnrsDataManager\Excel\Writer\Xlsx\Rels;
use CnrsDataManager\Excel\Writer\Xlsx\RelsRibbon;
use CnrsDataManager\Excel\Writer\Xlsx\RelsVBA;
use CnrsDataManager\Excel\Writer\Xlsx\StringTable;
use CnrsDataManager\Excel\Writer\Xlsx\Style;
use CnrsDataManager\Excel\Writer\Xlsx\Table;
use CnrsDataManager\Excel\Writer\Xlsx\Theme;
use CnrsDataManager\Excel\Writer\Xlsx\Workbook;
use CnrsDataManager\Excel\Writer\Xlsx\Worksheet;
use ZipArchive;
use CnrsDataManager\Libs\ZipStream\Exception\OverflowException;
...
class Xlsx extends BaseWriter
{
     ...
     *
     * @var HashTable<\CnrsDataManager\Excel\Style\Style>
     */
    ...
    /**
     * Private unique \CnrsDataManager\Excel\Style\Font HashTable.
     *
     * @var HashTable<Font>
     */
    ...
    /**
     * Private unique \CnrsDataManager\Excel\Worksheet\Worksheet\BaseDrawing HashTable.
     *
     ...
     * Get Style HashTable.
     *
     * @return HashTable<\CnrsDataManager\Excel\Style\Style>
     */
    ...
    /**
     * Get \CnrsDataManager\Excel\Style\Font HashTable.
     *
    ...
    /**
     * Get \CnrsDataManager\Excel\Worksheet\Worksheet\BaseDrawing HashTable.
     *
