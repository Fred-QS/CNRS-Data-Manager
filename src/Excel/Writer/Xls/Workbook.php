...
class Workbook extends BIFFwriter
{
     ...
     */
    public function addFont(\CnrsDataManager\Excel\Style\Font $font): int
    {
     ...
     */
    private function writeBoundSheet(\CnrsDataManager\Excel\Worksheet\Worksheet $sheet, int $offset): void
    {
        $sheetname = $sheet->getTitle();
        $record = 0x0085; // Record identifier
        $ss = match ($sheet->getSheetState()) {
            \CnrsDataManager\Excel\Worksheet\Worksheet::SHEETSTATE_VISIBLE => 0x00,
            \CnrsDataManager\Excel\Worksheet\Worksheet::SHEETSTATE_HIDDEN => 0x01,
            \CnrsDataManager\Excel\Worksheet\Worksheet::SHEETSTATE_VERYHIDDEN => 0x02,
            default => 0x00,
        };
