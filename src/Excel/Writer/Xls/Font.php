...
class Font
{
     ...
     * Font.
     */
    private \CnrsDataManager\Excel\Style\Font $font;

    /**
     * Constructor.
     */
    public function __construct(\CnrsDataManager\Excel\Style\Font $font)
    {
    ...
    public function writeFont(): string
    {
        ...
        $bCharSet = \CnrsDataManager\Excel\Shared\Font::getCharsetFromFontName((string) $this->font->getName()); // Character set
    ...
    private static array $mapUnderline = [
        \CnrsDataManager\Excel\Style\Font::UNDERLINE_NONE => 0x00,
        \CnrsDataManager\Excel\Style\Font::UNDERLINE_SINGLE => 0x01,
        \CnrsDataManager\Excel\Style\Font::UNDERLINE_DOUBLE => 0x02,
        \CnrsDataManager\Excel\Style\Font::UNDERLINE_SINGLEACCOUNTING => 0x21,
        \CnrsDataManager\Excel\Style\Font::UNDERLINE_DOUBLEACCOUNTING => 0x22,
    ];
