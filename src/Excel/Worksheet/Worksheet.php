...
use CnrsDataManager\Excel\Cell\IValueBinder;
use CnrsDataManager\Excel\Chart\Chart;
use CnrsDataManager\Excel\Collection\Cells;
use CnrsDataManager\Excel\Collection\CellsFactory;
use CnrsDataManager\Excel\Comment;
use CnrsDataManager\Excel\DefinedName;
use CnrsDataManager\Excel\Exception;
use CnrsDataManager\Excel\IComparable;
use CnrsDataManager\Excel\ReferenceHelper;
use CnrsDataManager\Excel\RichText\RichText;
use CnrsDataManager\Excel\Shared;
...
use CnrsDataManager\Excel\Style\Protection as StyleProtection;
...
class Worksheet implements IComparable
{
    ...
    /**
     * @throws Exception
     * @throws \CnrsDataManager\Excel\Calculation\Exception
     */
