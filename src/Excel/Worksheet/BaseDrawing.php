...
use CnrsDataManager\Excel\Worksheet\Drawing\Shadow;
...
class BaseDrawing implements IComparable
{
    ...
    public function setWorksheet(?Worksheet $worksheet = null, bool $overrideOld = false): self
    {
        if ($this->worksheet === null) {
            // Add drawing to \CnrsDataManager\Excel\Worksheet\Worksheet
            if ($worksheet !== null) {
            ...
            if ($overrideOld) {
                // Remove drawing from old \CnrsDataManager\Excel\Worksheet\Worksheet
                ...
                // Set new \CnrsDataManager\Excel\Worksheet\Worksheet
