...
use CnrsDataManager\Excel\Calculation\Internal\WildcardMatch;
...
use CnrsDataManager\Excel\Worksheet\AutoFilter\Column\Rule;
use Stringable;
    ...
    public function __clone()
    {
        ...
        foreach ($vars as $key => $value) {
            if (is_object($value)) {
                ...
                //    The columns array of \CnrsDataManager\Excel\Worksheet\Worksheet\AutoFilter objects
                $this->{$key} = [];
