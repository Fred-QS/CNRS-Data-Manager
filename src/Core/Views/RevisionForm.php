                ...
                <?php foreach ($form['elements'] as $element): ?>
                        ...
                        <div class="cnrs-dm-front-mission-form-element cnrs-dm-front-checkbox-wrapper" data-type="<?php echo $element['type'] ?>" data-state="<?php echo $data['required'] === true ? 'light' : 'black' ?>">
                            ...
                            <?php foreach ($data['choices'] as $choice): ?>
                                <label class="cnrs-dm-front-checkbox-label" data-option="<?php echo stripos($choice, '-opt-comment') !== false ? 'option' : 'normal' ?>">
                                    <input disabled class="checkbox__trigger visuallyHidden" value="<?php echo str_replace('-opt-comment', '', $choice) ?>" type="checkbox"<?php echo in_array(str_replace('-opt-comment', '', $choice), $data['values'], true) ? ' checked' : '' ?>>
                    ...
                    <?php elseif ($element['type'] === 'radio'): ?>
                        <div class="cnrs-dm-front-mission-form-element cnrs-dm-front-radio-references" data-type="<?php echo $element['type'] ?>" data-state="<?php echo $data['required'] === true ? 'light' : 'black' ?>">
                            ...
                            <?php foreach ($data['choices'] as $choice): ?>
                                <label>
                                    <input disabled value="<?php echo str_replace('-opt-comment', '', $choice) ?>" type="radio"<?php echo in_array(str_replace('-opt-comment', '', $choice), $data['values'], true) ? ' checked' : '' ?> class="cnrs-dm-front-radio-revision-input">
                ...
                <?php foreach ($form['elements'] as $element): ?>
                    ...
                    <?php if ($element['type'] === 'checkbox'): ?>
                        ...
                        <div class="cnrs-dm-front-mission-form-element cnrs-dm-front-mission-form-element-revision cnrs-dm-front-checkbox-wrapper<?php echo $obs !== null ? ' cnrs-dm-front-revision-obs' : '' ?>" data-type="<?php echo $element['type'] ?>" data-state="<?php echo $data['required'] === true ? 'light' : 'black' ?>">
                            ...
                            <?php foreach ($data['choices'] as $choice): ?>
                                <label class="cnrs-dm-front-checkbox-label" data-option="<?php echo stripos($choice, '-opt-comment') !== false ? 'option' : 'normal' ?>">
                                    <input<?php echo $obs === null ? ' disabled' : ' name="cnrs-dm-front-mission-form-element-' . $element['type'] . '-' . $index . '[]"' ?> class="checkbox__trigger visuallyHidden" value="<?php echo str_replace('-opt-comment', '', $choice) ?>" type="checkbox"<?php echo in_array(str_replace('-opt-comment', '', $choice), $data['values'], true) ? ' checked' : '' ?>>
                                    <span class="checkbox__symbol">
                                        <svg aria-hidden="true" class="icon-checkbox" width="28px" height="28px" viewBox="0 0 28 28" version="1" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M4 14l8 7L24 7"></path>
                                        </svg>
                    ...
                    <?php elseif ($element['type'] === 'radio'): ?>
                        ...
                        <div class="cnrs-dm-front-mission-form-element cnrs-dm-front-mission-form-element-revision cnrs-dm-front-radio-references<?php echo $obs !== null ? ' cnrs-dm-front-revision-obs' : '' ?>" data-type="<?php echo $element['type'] ?>" data-state="<?php echo $data['required'] === true ? 'light' : 'black' ?>">
                            ...
                            <?php foreach ($data['choices'] as $choice): ?>
                                <label>
                                    <input<?php echo $obs === null ? ' disabled class="cnrs-dm-front-radio-revision-input"' : ' name="cnrs-dm-front-mission-form-element-' . $element['type'] . '-' . $index . '"' ?> value="<?php echo str_replace('-opt-comment', '', $choice) ?>" type="radio"<?php echo in_array(str_replace('-opt-comment', '', $choice), $data['values'], true) ? ' checked' : '' ?>>
                                    <span class="design"></span>
                                    <span class="text"><?php echo str_replace('-opt-comment', '', $choice) ?></span>
                                </label>
                                <?php if (stripos($choice, '-opt-comment') !== false): ?>
