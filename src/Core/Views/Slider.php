<div class="cnrs-dm-front-slider" data-shortcode="cnrs-data-manager-shortcode-<?php echo $shortCodesCounter ?>">
    <h3 class="cnrs-dm-front-slider-title"><?php echo sprintf(__('%s in pictures', 'cnrs-data-manager'), html_entity_decode(get_post_meta($project->ID, 'cnrs_project_acronym', true))) ?></h3>
