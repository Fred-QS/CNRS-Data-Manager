...
use CnrsDataManager\Libs\Psr\Http\Message\StreamInterface;
use RuntimeException;
use CnrsDataManager\Libs\ZipStream\Exception\FileNotFoundException;
use CnrsDataManager\Libs\ZipStream\Exception\FileNotReadableException;
...
class ZipStream
{
     ...
     *     fileName: 'streamfile.txt',
     *     exactSize: $size,
     *     callback: function() use($name): CnrsDataManager\Libs\Psr\Http\Message\StreamInterface {
