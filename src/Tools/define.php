...
$docIcon = file_get_contents(CNRS_DATA_MANAGER_PATH . '/assets/icons/documentation.svg');
$emailIcon = file_get_contents(CNRS_DATA_MANAGER_PATH . '/assets/icons/email.svg');
$collaboratorsIcon = file_get_contents(CNRS_DATA_MANAGER_PATH . '/assets/icons/collaborators.svg');
...
define('CNRS_DATA_MANAGER_DOC_ICON', $docIcon);
define('CNRS_DATA_MANAGER_EMAIL_ICON', $emailIcon);
define('CNRS_DATA_MANAGER_COLLABORATORS_ICON', $collaboratorsIcon);
...
define('CNRS_DATA_MANAGER_TCPDF_PATH', CNRS_DATA_MANAGER_PATH . '/src/Libs/TCPDF');
define('CNRS_DATA_MANAGER_PROJECTS_DISPLAY_NUMBER', 16);

//define('CNRS_DATA_MANAGER_MAINTENANCE_IP', '83.192.198.103');
